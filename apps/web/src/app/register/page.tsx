...
export default function RegisterPage() {
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,#eadcff,transparent_36%),linear-gradient(135deg,#f8fafc,#f7f2ff)] px-5 py-10 sm:py-16">
        ...
        <section className="bg-[#240046] p-8 text-white sm:p-12">
          ...
          <div className="mt-20">
            ...
            <h1 className="mt-4 text-4xl font-bold leading-tight">
              Serve, grow, and stay connected.
            </h1>
            <p className="mt-5 max-w-sm leading-7 text-[#eadcff]">
              Create your member account to access attendance, events,
              departments, and your service history.
            </p>
          </div>
        </section>
