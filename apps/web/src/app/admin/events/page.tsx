  ...
  return (
    <main className="min-h-screen bg-slate-50 px-5 py-8 text-slate-950">
      <div className="mx-auto max-w-7xl">
        ...
        <section className="mt-8 border-y border-slate-200 bg-white py-6">
              ...
              >
                <div>
                  <div className="flex items-center gap-2">
                    <FiCalendar className="text-[#6b21a8]" aria-hidden="true" />
                  ...
                  <Link
                    className="mt-3 inline-flex text-sm font-bold text-[#6b21a8]"
                    href={`/admin/events/${event.id}`}
                  >
                    Manage event
                  </Link>
                </div>
                <span className="h-fit bg-purple-50 px-3 py-1 text-xs font-bold text-[#6b21a8]">
                  {event.status}
                </span>
              </article>
            ))}
