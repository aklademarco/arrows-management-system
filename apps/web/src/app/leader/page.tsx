  ...
  return <main className="min-h-screen p-4 sm:p-6 xl:p-8">
    <div className="mx-auto max-w-[1450px]">
      <div className="flex items-center gap-3">
        ...
        <Link aria-label="Notifications" className="relative grid size-12 place-items-center rounded-2xl border border-white/10 bg-[#24202e] text-slate-300" href="/member/notifications"><FiBell />{unread.count ? <span className="absolute -right-1 -top-1 grid min-w-5 place-items-center rounded-full bg-lime-400 px-1 text-[10px] font-black text-[#240046]">{unread.count}</span> : null}</Link>
      </div>
