...
type Item = { id: string; type: string; title: string; instructions: string | null; status: string; sentAt: string | null; createdAt: string; songs: Song[] };
type Overview = { canSubmitSongList: boolean; choirDepartment?: { name: string }; mediaDepartment?: { name: string }; items: Item[] };
