...
export default async function VerifyEmailPage({
  ...
  return (
    <main className="auth-shell grid min-h-screen place-items-center bg-[radial-gradient(circle_at_top_left,_#eadcff,_transparent_36%),linear-gradient(135deg,#f8fafc,#f7f2ff)] px-5 py-12">
